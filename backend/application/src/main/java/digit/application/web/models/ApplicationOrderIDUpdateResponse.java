...
@NoArgsConstructor
@Builder
public class ApplicationOrderIDUpdateResponse {
    ...
    public ApplicationOrderIDUpdateResponse updateResponseMsg(String responseMsg) {
        this.responseMsg = responseMsg; 
        return this;  // Return this for method chaining
    }
    public ApplicationOrderIDUpdateResponse updateResponseMsgforfailure(String failureresponseMsg) {
