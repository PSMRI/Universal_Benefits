package digit.verification.config;
...
public class ServiceConstants {
    ...
    public static final Set<String> SORTABLE_APPLICATION_COLUMNS = Collections.unmodifiableSet(
            Stream.of("created_time", "last_modified_time").collect(Collectors.toSet()));
