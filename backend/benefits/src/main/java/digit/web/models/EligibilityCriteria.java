...
public class EligibilityCriteria   {
        ...
        @Size(max=128)         private String propertyClass = null;

        @JsonProperty("marks")

        @Size(max=128)         private String marks = null;

        @JsonProperty("minQualification")

        @Size(max=128)         private String minQualification = null;

        @JsonProperty("fieldOfStudy")

        @Size(max=128)         private String fieldOfStudy = null;

        @JsonProperty("attendancePercentage")

        @Size(max=128)         private String attendancePercentage = null;

        @JsonProperty("annualIncome")

        @Size(max=128)         private String annualIncome = null;
        ...
        @Size(max=128)         private String domicile = null;

            /**
            * Type of student eligible for the benefit
            */
